...
<body>
    <div class="admin-layout">
        <nav class="sidebar">
            ...
            <ul class="nav-menu">
                <li class="active"><a href="/admin/tiles.php">Tiles</a></li>
    ...
    <script>
        ...
        async function loadTiles() {
            try {
                ...
                document.getElementById('tilesGrid').innerHTML = '<div class="empty-state">Failed to load tiles</div>';
            }
        }
        ...
        function renderTiles() {
            ...
            grid.innerHTML = tiles.map((tile, index) => {
                const hostname = tile.target_url ? new URL(tile.target_url).hostname : '';
                return `
                    <div class="tile-card" data-tile-id="${tile.id}" draggable="true">
                        ...
                        <div class="tile-info">
                            ...
                            <div class="tile-meta">
                                <span>${escapeHtml(tile.cta_label)} → ${escapeHtml(hostname)}</span>
                            </div>
                        </div>
        ...
        document.getElementById('tileForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                alert('Network error: Failed to save tile');
            }
        });
        ...
        async function showMediaPicker() {
            ...
            if (media.length === 0) {
                grid.innerHTML = '<div class="empty-state">No media available. Upload some images first!</div>';
            } else {
